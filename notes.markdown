...
* **Ask about** *Firearms* + buy 6 **Granades** (-600¥)
* Leave

Time `0:04:17` Delta `00:44`

#### Building with Double Door (name?)

* Got a bit southeast
* Enter building with double door
* Enter second room (right side)
* Pick up **Cyberdeck** (Pick up range quite long)
* Leave + equip **ID badge** and **Shades**

#### Morgue (Second Time)
* Go northeast to morgue (Take upper [sidewalk]()
* Enter morgue
* Open Door
* **Ask about** *Grinder* to lower right of the both **Mortician**.
* Move between both **Filing Cabinet**
* First **Filling Cabinet**
	* **Open** - **Examine** - pickup **Credstick**
* Second **Filling Cabinet**
	* **Open** - **Examine** - pickup **Tickets**
* Leave
...
#### Third Fight
* Strat 1:
	* **Use** **Granade** on **Heavy Dude** to [turn him red]() (at least 6 dmg needed)
...
* **Use** (five|six) **Grenade** on **King** to [turn him red]()
...
* **Pick up** **Crowbar**
* Enter next room
* **Use** five **Granades** on ** **
* **Use** one **Granade** on **Heavy Dude** on the left side
...
* Go southeast
* Enter **Sewers**
* **Kitsune**:  **Cast Spell** **Summon spirit lvl5** 
* Kill all **Rats**
* Go northeast
* **Kitsune**:  **Cast Spell** **Summon spirit lvl5** 
* Kill all **Rats**
